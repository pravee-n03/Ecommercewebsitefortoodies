    ...
    <div className="min-h-screen bg-black relative overflow-hidden selection:bg-[#d4af37]/30">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-12">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-black text-white mb-4 glow-text uppercase tracking-wide">Terms and Conditions</h1>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="mb-6">
          <Card className="glass-card border-[#d4af37]/15 rounded-2xl">
            ...
            <CardContent className="space-y-4">
              <p className="text-slate-300">By creating an account, placing an order, or using any of our services, you acknowledge that:</p>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="mb-6">
          <Card className="glass-card border-[#d4af37]/15 rounded-2xl">
            <CardHeader>
              <CardTitle className="text-white">Account Registration and Security</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <h3 className="text-[#d4af37] uppercase tracking-widest text-sm font-bold mb-3">Registration Requirements</h3>
                <ul className="list-disc list-inside text-slate-400 space-y-2 ml-4">
              ...
              <div>
                <h3 className="text-[#d4af37] uppercase tracking-widest text-sm font-bold mb-3">Account Security</h3>
                <ul className="list-disc list-inside text-slate-400 space-y-2 ml-4">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="mb-6">
          <Card className="glass-card border-[#d4af37]/15 rounded-2xl">
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="text-[#d4af37] uppercase tracking-widest text-sm font-bold mb-3">Product Information</h3>
                <ul className="list-disc list-inside text-slate-400 space-y-2 ml-4">
              ...
              <div>
                <h3 className="text-[#d4af37] uppercase tracking-widest text-sm font-bold mb-3">Order Placement</h3>
                <ul className="list-disc list-inside text-slate-400 space-y-2 ml-4">
              ...
              <div>
                <h3 className="text-[#d4af37] uppercase tracking-widest text-sm font-bold mb-3">Custom Designs</h3>
                <ul className="list-disc list-inside text-slate-400 space-y-2 ml-4">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="mb-6">
          <Card className="glass-card border-[#d4af37]/15 rounded-2xl">
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="text-[#d4af37] uppercase tracking-widest text-sm font-bold mb-3">Pricing</h3>
                <ul className="list-disc list-inside text-slate-400 space-y-2 ml-4">
              ...
              <div>
                <h3 className="text-[#d4af37] uppercase tracking-widest text-sm font-bold mb-3">Payment Methods</h3>
              ...
              <div>
                <h3 className="text-[#d4af37] uppercase tracking-widest text-sm font-bold mb-3">Payment Processing</h3>
                <ul className="list-disc list-inside text-slate-400 space-y-2 ml-4">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }} className="mb-6">
          <Card className="glass-card border-[#d4af37]/15 rounded-2xl">
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="text-[#d4af37] uppercase tracking-widest text-sm font-bold mb-3">Shipping Policy</h3>
                <ul className="list-disc list-inside text-slate-400 space-y-2 ml-4">
              ...
              <div>
                <h3 className="text-[#d4af37] uppercase tracking-widest text-sm font-bold mb-3">Delivery Terms</h3>
                <ul className="list-disc list-inside text-slate-400 space-y-2 ml-4">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7 }} className="mb-6">
          <Card className="glass-card border-[#d4af37]/15 rounded-2xl">
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="text-[#d4af37] uppercase tracking-widest text-sm font-bold mb-3">Return Eligibility</h3>
                <ul className="list-disc list-inside text-slate-400 space-y-2 ml-4">
              ...
              <div>
                <h3 className="text-[#d4af37] uppercase tracking-widest text-sm font-bold mb-3">Refund Process</h3>
                <ul className="list-disc list-inside text-slate-400 space-y-2 ml-4">
              ...
              <div>
                <h3 className="text-[#d4af37] uppercase tracking-widest text-sm font-bold mb-3">Exchanges</h3>
                <ul className="list-disc list-inside text-slate-400 space-y-2 ml-4">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.8 }} className="mb-6">
          <Card className="glass-card border-[#d4af37]/15 rounded-2xl">
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="text-[#d4af37] uppercase tracking-widest text-sm font-bold mb-3">Our Content</h3>
                <p className="text-slate-300 mb-2">All content on the Toodies website, including but not limited to text, graphics, logos, images, and software, is the property of Toodies and protected by copyright and intellectual property laws.</p>
              </div>
              <div>
                <h3 className="text-[#d4af37] uppercase tracking-widest text-sm font-bold mb-3">Your Content</h3>
                <ul className="list-disc list-inside text-slate-400 space-y-2 ml-4">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.0 }} className="mb-6">
          <Card className="glass-card border-[#d4af37]/15 rounded-2xl">
            <CardHeader>
              <CardTitle className="text-white">Limitation of Liability</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-slate-300">To the fullest extent permitted by law:</p>
              <ul className="list-disc list-inside text-slate-400 space-y-2 ml-4">
        ...
        {/* Governing Law */}
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.1 }} className="mb-6">
          <Card className="glass-card border-[#d4af37]/15 rounded-2xl">
            <CardHeader>
              <CardTitle className="text-white">Governing Law and Disputes</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-slate-300">These Terms are governed by the laws of India. Any disputes arising from these Terms or your use of our services shall be subject to the exclusive jurisdiction of the courts in Mumbai, Maharashtra, India.</p>
              <p className="text-slate-300">Before initiating legal action, we encourage you to contact us at support@toodies.com to resolve any disputes amicably.</p>
            </CardContent>
          </Card>
        </motion.div>

        {/* Changes to Terms */}
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.2 }} className="mb-6">
          <Card className="glass-card border-[#d4af37]/15 rounded-2xl">
            <CardHeader>
              <CardTitle className="text-white">Changes to Terms</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-slate-300">We reserve the right to modify these Terms at any time. Changes will be effective immediately upon posting to the website. Your continued use of our services after changes constitutes acceptance of the modified Terms. We encourage you to review these Terms periodically.</p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.3 }}>
          <Card className="glass-card border-[#d4af37]/15 rounded-2xl">
            ...
            <CardContent>
              <p className="text-slate-300 mb-4">If you have any questions about these Terms and Conditions, please contact us:</p>
